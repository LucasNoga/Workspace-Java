...
public class Polynome {
	...
	public void calculerRacine() throws ArithmeticException, InvalidPolynomException{
		...
		if(discriminant > 0){
			try{
				...
				throw new InvalidPolynomException("test");
			}
		}
	...
	public static void main(String[] args) {
		Polynome calcul1 = new Polynome(1, 0, 1);
